...
export default function Reviews() {
  return (
    <section id='reviews' className="bg-muted py-16 px-4">
      ...
      <div className="space-y-10 max-w-4xl mx-auto">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="relative bg-white p-6 rounded-xl shadow-sm border-l-4 border-primary"
          >
            <Quote className="absolute -top-4 left-4 text-primary w-6 h-6 bg-white rounded-full p-1 shadow" />
